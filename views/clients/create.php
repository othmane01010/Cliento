...
<div class="form-container">
    <div class="card">
        ...
        <form action="/clients/store" method="POST" enctype="multipart/form-data" class="form-body">
            ...
            <div class="form-group">
                <label for="photo" class="form-label">Photo de profil <small class="text-muted">(Optionnel - JPG, PNG, WEBP max 2Mo)</small></label>
                <input 
                    type="file" 
                    id="photo" 
                    name="photo" 
