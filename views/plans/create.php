<?php
$pageTitle = "Créer un plan d'abonnement";
...
<div class="form-container">
    <div class="card">
        <div class="card-header flex-between">
            <h3 class="card-title">Nouveau Plan</h3>
        ...
        <form action="/plans/store" method="POST" class="form-body">
            ...
            <div class="form-group">
                ...
                <input 
                    ...
                    placeholder="ex: Mensuel Standard, Annuel Pro..." 
                    required
                >
            ...
            <div class="form-group">
                ...
                <input 
                    ...
                    value="<?= htmlspecialchars($old['duration_days'] ?? '30') ?>" 
                    placeholder="ex: 30" 
                    required
                >
